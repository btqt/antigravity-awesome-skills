...
**Pro Tip:** Sử dụng [Starter Packs](BUNDLES_vi.md) để cài đặt chỉ những thứ phù hợp với vai trò của bạn.
...
- [BUNDLES.md](BUNDLES_vi.md)
- [WORKFLOWS.md](WORKFLOWS_vi.md)
...
1. **Khám phá danh mục (catalog)**: Hãy kiểm tra [Skill Catalog](../CATALOG_vi.md).
