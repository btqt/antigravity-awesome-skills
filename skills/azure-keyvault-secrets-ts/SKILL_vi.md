...
description: Quản lý secrets sử dụng Azure Key Vault Secrets SDK cho JavaScript (@azure/keyvault-secrets). Sử dụng khi lưu trữ và truy xuất các secrets của ứng dụng hoặc các giá trị cấu hình.
package: @azure/keyvault-secrets
---

# Azure Key Vault Secrets SDK cho TypeScript
